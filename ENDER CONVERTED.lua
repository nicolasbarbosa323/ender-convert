...
local Frame_Speed = 77 -- The frame speed for swait. 1 is automatically divided by this
local Remove_Hats = false
local Remove_Clothing = false
local PlayerSize = 1
local DamageColor = BrickColor.Random()
local MusicID = 1843497734
...
local Static = Sound(Torso,1140666966,1,3,true,false,true)
Static.Name = 'Static'
...
function Taunt()
	...
	Sound(Torso,314390675,1.3,10,false,true,true)
	for i = 0, 3, 0.1 do
		swait()
		local Alpha = 1
...
function SnapAFaggotsNeck()
	...
	if(whom and hum and hed and hum.Health > 0)then
		...
		Sound(Head,584533998,.8,10,false,true,true)
		WalkSpeed = oWS
		Attack = false
		NeutralAnims = true
	end
...
function Boolets()
	...
	Sound(RArm,238353911,.8,6,false,true,true)
	coroutine.wrap(function()
		for i = 0, 1, .05 do
			ray.Transparency = i
			swait()
...
function BurnInHell()
	...
	if(hit)then
		Sound(Root,584533998,1,10,false,true,true)
		...
		Sound(Head,1140666966,1,5,false,true,true)
	end
	WalkSpeed = oWS
	Attack = false
	NeutralAnims = true
...
function Punch1()
	...
	Sound(RArm,314390675,.8,5,false,true,true)
	CamShake(Char,10,20)
	for i = 0, 1, 0.1 do
		swait()
...
local Nametags = {"NERO!","NERO","N3R0","3nd37","end3r","end37","3nder","3nde7","ENDer","eNDER","eNder","enDer","endEr","endeR","H3LP ME"}
coroutine.wrap(function()
	while true do
...
while true do
	...
	Static.SoundId = "rbxassetid://584533998"
	Static.Parent = Torso
